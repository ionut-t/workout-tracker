...
export class WorkoutService {
   ...
   * -> return an array of exercises based on Exercise model
  ...
  /**
   * @param selectedId -> id of exercise selected by the user
   * Return the exercise selected by the user
  ...
  /**
   * Return a copy of the workout in progress
   */
  getRunningWorkout() {
   ...
   * Emit a new value whenever the user gets a new finished workout session from the server
   */
